...
def enviarMensaje(mensaje):
    ...
    return True
def verificarDistribucionBarcosServidor():
    data = sock.recv(50)
...
def juegoCompleto(jugador1F):
    ...
    while bandera:
        ...
        banderaAtaque=verificarDistribucionBarcosServidor()        
        i=0
        while bandera2 and banderaAtaque:
            ...
            while verificarTurno()and bandera2:
                if contadorGlobal1==15:
                    print 'HEMOS GANADO LA GUERRA COMANDANTE',jugador1F
                ...
                if aciertoJug1== True:
                    ...
                    enviarMensaje('Tu enemigo ha acertado a uno de tus barcos')
                    
                else:
                    enviarMensaje('turno')
                    verificarTurno()
                    contadorSurrender+=1
                print 'esperando ataque de el otro jugador'
        bandera=False    
    return False
...
def distribuirBarcos(tablero):
    ...
    contador=0
    posiciones=''
    #contador para la distribucion de barcos 
...
#procesamiento
jugador1F=jugador1
print 'BIENVENIDO A LA GUERRA COMANDANTE',jugador1F
#proceso con socket
